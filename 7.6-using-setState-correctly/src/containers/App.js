...
class App extends Component {
  ...
  //7.6 because toggleClicked could be asyn and using by different funcs -> using prev state
  // data can be changed -> if you worry, then using it
  togglePersonHandler = () => {
